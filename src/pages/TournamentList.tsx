            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                        {t('menu_tournaments') || 'Turnuvalar'}
                        <span className="text-sm font-normal text-gray-500 bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full">
                            {tournaments.length}
                        </span>
                    </h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Takımının katıldığı tüm organizasyonlar.</p>
                </div>
                ...
                <div className="flex gap-3">
                    <div className="relative">
                        ...
                        <input 
                            type="text" 
                            className="pl-9 pr-4 py-2 bg-white dark:bg-[#1E1E1E] border border-gray-200 dark:border-gray-700 rounded-xl text-sm focus:ring-2 focus:ring-[#5B4DBC] outline-none shadow-sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {tournaments.map((tour) => (
                    <div 
                        ...
                        className="group bg-white dark:bg-[#1E1E1E] rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-transparent hover:border-[#5B4DBC]/30 cursor-pointer overflow-hidden relative"
                    >
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className="bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                                    Turnuva
                                </span>
                            </div>
                            
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-[#5B4DBC] transition-colors line-clamp-1">
                                {tour.tournamentName}
                            </h3>
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800">
                                ...
                                <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-800 flex items-center justify-center group-hover:bg-[#5B4DBC] transition-colors">
                ...
                <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-700 flex flex-col items-center justify-center p-6 cursor-pointer hover:border-[#5B4DBC] hover:bg-[#5B4DBC]/5 transition-all group min-h-[200px]">
                    <div className="w-14 h-14 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center mb-4 group-hover:bg-white dark:group-hover:bg-[#1E1E1E] transition-colors">
                        <span className="material-icons-outlined text-3xl text-gray-400 group-hover:text-[#5B4DBC]">add</span>
                    </div>
                    <h3 className="text-lg font-bold text-gray-500 dark:text-gray-400 group-hover:text-[#5B4DBC]">Yeni Turnuva Ekle</h3>
                </div>
            </div>
        </div>
    );
